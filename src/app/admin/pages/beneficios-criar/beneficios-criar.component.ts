...
@Component({
  selector: 'app-beneficios-criar',
  templateUrl: './beneficios-criar.component.html',
  styleUrls: ['./beneficios-criar.component.scss']
})
export class BeneficiosCriarComponent implements OnInit {
  ...
  submit(f: NgForm) {
    ...
    this.beneficioService.post(this.data)
      .subscribe((res: any) => {
        this.submitImages(this.file, '/beneficio/imagem?id=' + res);
