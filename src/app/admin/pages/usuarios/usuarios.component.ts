...
import { UsuariosApi, UsuarioService } from 'src/app/services/admin/usuario.service';
// default
...
export class UsuariosComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', '1', '2', '3', 'actions'];
    ...
    merge(this.sort.sortChange, this.paginator.page)
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.usuarioService.get(this.paginator.pageIndex + 1, this.paginator.pageSize, this.sort.active, this.sort.direction.toLocaleUpperCase(), this.search);
        }),
        map(data => {
  ...
  deletarData(item: Usuario) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        ...
        this.usuarioService.delete(item).subscribe((res: any) => {
  ...
  deletarDatas() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.usuarioService.deleteSelected(this.selection.selected).subscribe((res: any) => {
  ...
  filter(e) {
    ...
    if (e) {
      ...
      this.filterSubscription = this.usuarioService.get(this.paginator.pageIndex + 1, this.paginator.pageSize, this.sort.active, this.sort.direction.toLocaleUpperCase(), e.toLocaleLowerCase())
