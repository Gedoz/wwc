...
@NgModule({
  declarations: [
    ...
    HeaderComponent, 
    AdminComponent, ClientesComponent, ClientesCriarComponent, ClientesEditarComponent, ContatoGeralComponent, ConfiguracaoGeralComponent, ConfiguracaoEmailComponent, DepoimentosComponent, DepoimentosCriarComponent, DepoimentosEditarComponent, BannerComponent, BeneficiosComponent, BeneficiosCriarComponent, BeneficiosEditarComponent, PerguntasComponent, PerguntasCriarComponent, PerguntasEditarComponent, ModulosComponent, ModulosCriarComponent, ModulosEditarComponent, FuncionalidadesComponent, FuncionalidadesModalComponent, ConsultoriasComponent, ConsultoriasCriarComponent, ConsultoriasEditarComponent
  ],
  imports: [
    CommonModule,
    AdminRoutingModule,
